                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="dc_id">
                                    @foreach($server_detail as $data)
                                      <option value="{{$data->dc_id}}">{{$data->dc_name}}</option>
                                    @endforeach
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <!-- {!! Form::text('server_password', old('server_password'), ['class' => 'form-control', 'placeholder' => '', 'value' => $server_password]) !!} -->
                                <input type="text" class="form-control" placeholder="Server Password" name="server_password" value="<?php echo $server_password ?>" />
                            </div>
                        </div>
                    </div>
                </div>
