...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['sec.branch.store']]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('branch_name', old('branch_name'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                </div>
                <div class="col-xs-6 form-group">
                    {!! Form::label('name', 'Branch Code*', ['class' => 'control-label']) !!}
                    {!! Form::text('branch_code', old('branch_code'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-xs-6 form-group">
                    {!! Form::label('name', 'Branch Telkom IP*', ['class' => 'control-label']) !!}
                    {!! Form::text('branch_ip_telkom', old('branch_ip_telkom'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                </div>
                <div class="col-xs-6 form-group">
                    {!! Form::label('name', 'Branch Lintasarta IP', ['class' => 'control-label']) !!}
                    {!! Form::text('branch_ip_lintas', old('branch_ip_lintas'), ['class' => 'form-control', 'placeholder' => '']) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-xs-6 form-group">
                    {!! Form::label('name', 'Branch Indihome ID', ['class' => 'control-label']) !!}
                    {!! Form::text('branch_indihome_id', old('branch_indihome_id'), ['class' => 'form-control', 'placeholder' => '']) !!}
                </div>
                <div class="col-xs-6 form-group">
                    {!! Form::label('name', 'Branch Telephone*', ['class' => 'control-label']) !!}
                    {!! Form::text('branch_telephone', old('branch_telephone'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-xs-6 form-group">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::textarea('branch_address', old('branch_address'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                </div>
            </div>
        </div>
    </div>
