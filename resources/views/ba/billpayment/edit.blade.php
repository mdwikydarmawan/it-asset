...
@section('content')
    ...
    {!! Form::model($otherBilling, ['method' => 'PUT', 'route' => ['ba.billpayment.update', $otherBilling->id], 'files' => true]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('bill_date_1', old('bill_date_1'), ['class' => 'form-control datepicker', 'placeholder' => '', 'required' => '', 'id' => 'bill_date_1', 'disabled' => 'disabled']) !!}
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-2">
                                <div class="form-group">
                                    {!! Form::label('name', 'Invoice Number (Term 1)*', ['class' => 'control-label']) !!}
                                    {!! Form::text('bill_no_1', old('bill_no_1'), ['class' => 'form-control', 'placeholder' => '', 'required' => '', 'id' => 'bill_no_1', 'disabled' => 'disabled']) !!}
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('bill_date_2', old('bill_date_2'), ['class' => 'form-control datepicker', 'placeholder' => '', 'id' => 'bill_date_2', 'disabled' => 'disabled']) !!}
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-2">
                                <div class="form-group">
                                    {!! Form::label('name', 'Invoice Number (Term 2)', ['class' => 'control-label']) !!}
                                    {!! Form::text('bill_no_2', old('bill_no_2'), ['class' => 'form-control', 'placeholder' => '', 'id' => 'bill_no_2', 'disabled' => 'disabled']) !!}
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('bill_date_3', old('bill_date_3'), ['class' => 'form-control datepicker', 'placeholder' => '', 'id' => 'bill_date_3', 'disabled' => 'disabled']) !!}
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-2">
                                <div class="form-group">
                                    {!! Form::label('name', 'Invoice Number (Term 3)', ['class' => 'control-label']) !!}
                                    {!! Form::text('bill_no_3', old('bill_no_3'), ['class' => 'form-control', 'placeholder' => '', 'id' => 'bill_no_3', 'disabled' => 'disabled']) !!}
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('bill_date_4', old('bill_date_4'), ['class' => 'form-control datepicker', 'placeholder' => '', 'id' => 'bill_date_4', 'disabled' => 'disabled']) !!}
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-2">
                                <div class="form-group">
                                    {!! Form::label('name', 'Invoice Number (Term 4)', ['class' => 'control-label']) !!}
                                    {!! Form::text('bill_no_4', old('bill_no_4'), ['class' => 'form-control', 'placeholder' => '', 'id' => 'bill_no_4', 'disabled' => 'disabled']) !!}
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('bill_date_5', old('bill_date_5'), ['class' => 'form-control datepicker', 'placeholder' => '', 'id' => 'bill_date_5', 'disabled' => 'disabled']) !!}
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-2">
                                <div class="form-group">
                                    {!! Form::label('name', 'Invoice Number (Term 5)', ['class' => 'control-label']) !!}
                                    {!! Form::text('bill_no_5', old('bill_no_5'), ['class' => 'form-control', 'placeholder' => '', 'id' => 'bill_no_5', 'disabled' => 'disabled']) !!}
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <div class="form-group">
