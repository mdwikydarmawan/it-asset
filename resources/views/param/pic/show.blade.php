...
@section('content')
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('pic_name_2', old('pic_name_2'), ['class' => 'form-control', 'placeholder' => '', 'required' => '', 'disabled' => 'disabled']) !!}
                    {!! Form::label('name', 'PIC Telephone 2', ['class' => 'control-label']) !!}
                    {!! Form::text('pic_telephone_2', old('pic_telephone_2'), ['class' => 'form-control', 'placeholder' => '', 'required' => '', 'disabled' => 'disabled']) !!}
                </div>
            </div>
    ...
    <div>
        <a class="btn btn-danger" href="{{ route('param.pic.index') }}"> Back</a>
    </div>
    {!! Form::close() !!}
@stop